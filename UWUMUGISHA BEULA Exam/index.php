...
<body style="background-image: url('./images/wedding photo2.png');background-repeat: no-repeat;background-size: cover;">

<div class="overlay">
  <div class="container">
    <h1 style="color: pink;">WELCOME TO DreamDay Planner </h1>
